...
function Login() {
    ...
    const register = e => {
        ...
        auth.createUserWithEmailAndPassword(email, password)
            .then((auth) => {
                //it successfully createdanew user with
                //emailand password
                console.log(auth);
                if (auth) {
                    history.push('/');
    ...
    return (
        <div className='login'>
            ...
            <div className='login__container'>
                ...
                <p>
                    By Signing in you agree to our use of your personal information  in accordance with this Privacy Notice You also agree and consent to us collecting, storing, processing, transferring, and sharing your personal information .
                </p>

                <button onClick={register} className='login__registerButton'>Join Amazon</button>
            </div>
